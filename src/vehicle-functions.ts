...
export const ORIENTATIONS = ["N", "E", "S", "W"] as const; // NOTE FOR COACHES: wanted to mark this 'as const' but then didn't seem to be able to use indexOf to validate my input;
